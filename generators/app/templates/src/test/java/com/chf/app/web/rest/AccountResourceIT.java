...
import static <%=package%>.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import <%=package%>.constants.AuthoritiesConstants;
...
import <%=package%>.service.dto.UserDTO;
import <%=package%>.web.IntegrationTest;
