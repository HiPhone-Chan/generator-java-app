package <%=package%>.aop.logging;

import static <%=package%>.constants.SystemConstants.BASE_PACKAGE;
import static <%=package%>.constants.SystemConstants.PROFILE_DEVELOPMENT;
